...
Weekly homework programming assignments, two in-class written exams, three in-class programming quizzes, and an in-class written final exam.
...
To contest homework grades you must submit an an official regrade form to your grading TA **within one week of the assignment's original return date**. To contest quiz and exam grades you must submit an official regrade form to a TA **within one week of the assignment's original return date**. The original return date is the date the exam was first made available for students to pick up or the grade was posted online in the case of homework assignments and programming quizzes.
...
* Week 1 - Week 3: Element of Programming in Java (values, variables, control structures, classes)
* Week 4 - Week 6: Fundamentals of Object-Oriented Programming (inheritance, polymorphism)
* Week 7 - Week 9: OOP Case Studies (Java collections framework, Java GUI programming)
* Week 10 - Week 12: Algorithms and Data Structures
