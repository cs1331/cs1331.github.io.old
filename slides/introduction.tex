...
\vspace{-.05in}
Follow the instructions on the \link{http://www.cc.gatech.edu/~simpkins/teaching/gatech/cs1331/resources.html}{Resources} page of the course web site to install the JDK. Installing the JDK on your computer provides you with several command-line tools, the most important of which are:
