...
Every powerful language has three mechanisms for  combining simple ideas to form more complex ideas:\footnote{\link{http://mitpress.mit.edu/sicp/full-text/book/book-Z-H-10.html}{SICP 1.1}}
...
Compile and run \link{\code/basics/Expressions.java}{Expressions.java} and see what it prints.
...
If an expression contains no parentheses, Java evaluates expressions according to \link{http://docs.oracle.com/javase/tutorial/java/nutsandbolts/operators.html}{precedence} in a three-step process:
\begin{enumerate}
...
\item See \link{http://docs.oracle.com/javase/8/docs/api/java/lang/String.html}{http://docs.oracle.com/javase/8/docs/api/java/lang/String.html} for details.
...
Play with \link{\code/basics/Strings.java}{Strings.java}
