...
Take a look at the final evolution of our Card class, \link{\code/classes/Card.java}{Card.java}.  It contains a few more enhancements:
\begin{itemize}
...
Given our finished \link{\code/classes/Card.java}{Card.java} class with a properly implemented {\tt equals(Object)} method, this code:
\vspace{-.05in}
\begin{lstlisting}[language=Java]
